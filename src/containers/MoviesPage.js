...
const MoviesPage = ({ match, movies }) => (
  <div>
    ...
    {/* STEP 1 We also add a `Route` component that will render `MovieShow`
     when a movie is selected */}
    {/* <Route path={`${match.url}/:movieId`} component={MovieShow}/> */}

    {/* STEP 2 // Adding code to pass the movies to the `MovieShow` component
    ...
    {/* STEP 3 // Here we replace the `component` prop with the `render` prop so we can pass the 
